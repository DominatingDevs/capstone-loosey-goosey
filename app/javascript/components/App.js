...
class App extends Component {
  ...
  readListing = () => {
    ...
    .then(payload => {this.setState({listings: payload})})
    .catch(errors => {console.log("Gooseys read errors:", errors)})
  } 
  ...
  render() {
    ...
    return (
      ...
      <Switch>
        ...
        <Route path="/gooseyindex" render={(props) => <GooseyIndex listings={this.state.listings} />} />
